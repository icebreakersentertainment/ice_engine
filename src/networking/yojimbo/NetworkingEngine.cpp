...
double time_ = 100.0;
NetworkingEngine::NetworkingEngine(utilities::Properties* properties, fs::IFileSystem* fileSystem, logger::ILogger* logger)
	:
...
NetworkingEngine::NetworkingEngine(const NetworkingEngine& other)
{
}
...
ServerHandle NetworkingEngine::createServer()
{
...
ClientHandle NetworkingEngine::createClient()
{
	uint64_t clientId = 0;
...
void NetworkingEngine::destroyServer(const ServerHandle& serverHandle)
{
	
}

void NetworkingEngine::destroyClient(const ClientHandle& clientHandle)
{
...
void NetworkingEngine::send(const ServerHandle& serverHandle, const std::vector<uint8>& data)
{
...
void NetworkingEngine::send(const ServerHandle& serverHandle, const RemoteConnectionHandle& remoteConnectionHandle, const std::vector<uint8>& data)
{
	
}

void NetworkingEngine::send(const ClientHandle& clientHandle, const std::vector<uint8>& data)
{
...
void NetworkingEngine::tick(const float32 delta)
{
	for (auto& server : servers_)
	{
...
void NetworkingEngine::processEvents()
{
...
void NetworkingEngine::addEventListener(IEventListener* eventListener)
{
...
void NetworkingEngine::removeEventListener(IEventListener* eventListener)
{
