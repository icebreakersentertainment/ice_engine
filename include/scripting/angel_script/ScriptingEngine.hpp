...
public:
	...
	virtual void execute(const std::string& scriptData, const std::string& function, std::vector<Parameter> arguments, std::function<void(void*)> returnObjectParser, const ExecutionContextHandle& executionContextHandle = ExecutionContextHandle(0)) override;
