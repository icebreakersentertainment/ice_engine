...
public:
	...
	virtual glm::quat rotation(const entities::Entity& entity) = 0;
	...
	virtual glm::vec3 scale(const entities::Entity& entity) = 0;
	...
	virtual glm::vec3 position(const entities::Entity& entity) = 0;
};
