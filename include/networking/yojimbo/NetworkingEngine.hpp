#ifndef NETWORKINGENGINE_H_
#define NETWORKINGENGINE_H_
...
class NetworkingEngine : public INetworkingEngine
{
public:
	NetworkingEngine(utilities::Properties* properties, fs::IFileSystem* fileSystem, logger::ILogger* logger);
	virtual ~NetworkingEngine();
...
private:
	NetworkingEngine(const NetworkingEngine& other);
